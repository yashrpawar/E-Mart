...
<%@ page
	import="com.Emart.service.impl.*,com.Emart.service.*,com.Emart.beans.*,java.util.*,javax.servlet.ServletOutputStream,java.io.*"%>
<!DOCTYPE html>
<html>
<head>
			...
			<form action="./UpdateProductSrv" method="post"
				...
				<div style="font-weight: bold;" class="text-center">
					<div class="form-group">
						...
						<h2 style="color: #ffffff;">Product Update Form</h2>
					</div>
